...
class User(db.Model, UserMixin):
    ...
    password = db.Column(db.String(2,8), nullable=False)
...
class Produtos(db.Model):
    ...
    descricao = db.Column(db.String(300), unique=True, nullable=False)
...
class Pedidos(db.Model):
    ...
    valor_total = db.Column(db.String(120), unique=True, nullable=False)
...
def admin_dashboard():
    ...
    return render_template("dashboard.html", produtos=produtos, pedidos=pedidos, form=form)
